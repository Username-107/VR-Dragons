...
public class GameSceneManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        audioClipLength = FindObjectOfType<AudioManager>().musicTheme.clip.length;
    ...
    public IEnumerator StartCountdown(float countdownValue)
    {
        while (countdownValue > 0)
        {
            ...
            progressBarImage.fillAmount = (FindObjectOfType<AudioManager>().musicTheme.time / audioClipLength);
